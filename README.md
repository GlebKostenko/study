...
знать площадки, на которых эти мероприятия проводятся. Вам нужно разработать архитектуру такого приложения и нарисовать UML
